...
/// Sample chat titles for the logged-in view; replace with real data later.
const _sampleChats = [
...
class AppSidebar extends StatelessWidget {
  const AppSidebar({super.key, this.loggedIn = false, this.userEmail});
...
class AppDrawer extends StatelessWidget {
  const AppDrawer({super.key, this.loggedIn = false, this.userEmail});
  ...
  Widget build(BuildContext context) {
    return Drawer(
      ...
      child: AppSidebar(loggedIn: loggedIn, userEmail: userEmail),
    );
  }
}
      ...
      children: [
        ...
        Expanded(
          child: Text(
            ...
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
            style: const TextStyle(fontSize: 13.5, color: _greys),
          ),
        ),
        const SizedBox(width: 8),
